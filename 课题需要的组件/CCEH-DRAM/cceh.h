...
constexpr size_t kSegmentSize = (1 << kSegmentBits) * 16 * 4;   //段大小是 bucket_num * slot_num * per_Pair_size
...
struct Segment{
    static const size_t kNumSlot = kSegmentSize/sizeof(Pair);   //kNumSlot这里是
...
struct Directory{
    static const size_t kDefaultDepth = 4;
